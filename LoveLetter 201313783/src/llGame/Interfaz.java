...
class Interfaz {
	...
	void instrucciones(){
		...
		if(de.contains("s")){
			System.out.println("--(Valor) Carta <# de cartas en el maso>: descripcion--\n"
					+ "(1) Guard <4>: trata de adivinar la carta del oponente, si es correcto el oponente pierde la ronda\n"
